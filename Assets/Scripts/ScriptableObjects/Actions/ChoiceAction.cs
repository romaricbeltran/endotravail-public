...
public class Choice
{
	...
	[SerializeField] private List<Flag> endChoiceFlags;
	[SerializeField] bool forceShowEndChoiceFlag;
	...
	public List<Flag> EndChoiceFlags { get => endChoiceFlags; set => endChoiceFlags = value; }
	public bool ForceShowEndChoiceFlag { get => forceShowEndChoiceFlag; set => forceShowEndChoiceFlag = value; }
